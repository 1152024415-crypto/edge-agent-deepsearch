"""Static shell for the WAIC insight page (signal-monitor terminal aesthetic).

Single curated markdown report (site/waic/WAIC-insight.md) fetched client-side,
...
WAIC_HTML = r"""<!doctype html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>RADAR · WAIC 洞察</title>
...
<body>
  <main>
    <header class="scope">
      <h1>RADAR<span class="sub">WAIC 洞察 · 世界人工智能大会 2026</span></h1>
  ...
  <script>
    var MD_URL = 'waic/WAIC-insight.md';
    function render(md){
