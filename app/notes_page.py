...
<head>
  ...
  <style>
    *{box-sizing:border-box}
    ...
    .layout{display:grid;grid-template-columns:248px 1fr;gap:16px;align-items:start}
    .side{background:var(--panel);border:1px solid var(--rule);border-radius:6px;padding:12px 10px;position:sticky;top:12px;max-height:calc(100vh - 24px);overflow:auto}
    .side-title{font-family:"IBM Plex Mono",monospace;font-size:10px;color:var(--faint);text-transform:uppercase;letter-spacing:.5px;padding:4px 6px 8px;border-bottom:1px solid var(--hair);margin-bottom:6px}
    ...
    .art h2{font-size:17px;margin:26px 0 8px;padding-bottom:4px;border-bottom:1px solid var(--hair)}
    .art h3{font-size:14.5px;margin:18px 0 6px;color:var(--ink)}
    .art p{margin:8px 0}
    ...
    @media(max-width:760px){.layout{grid-template-columns:1fr}.side{position:static;max-height:none}}
  </style>
</head>
<body>
  <main>
