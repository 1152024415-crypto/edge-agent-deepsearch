...
for owner, repo, name in repos:
    ...
    for attempt in range(4):
        try:
            ...
            if e.code in (429,403): time.sleep(30)
            else: time.sleep(5)
        except Exception as e:
            print(f"ERR {owner}/{repo}: {e}"); time.sleep(5)
json.dump(out, open("research_runs/tmp/gh_snntorch.json","w",encoding="utf-8"), ensure_ascii=False, indent=2)
print("DONE")
